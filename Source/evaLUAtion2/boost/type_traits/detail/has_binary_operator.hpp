	...
	namespace detail {
		...
		namespace BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl) {
			...
			struct operator_exists {
				static ::boost::type_traits::yes_type ebinkek(has_operator); // this version is preferred when operator exists
				static ::boost::type_traits::no_type ebinkek(no_operator); // this version is used otherwise

				BOOST_STATIC_CONSTANT(bool, value = (sizeof(ebinkek(((make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>()), make<has_operator>()))) == sizeof(::boost::type_traits::yes_type)));
			};
